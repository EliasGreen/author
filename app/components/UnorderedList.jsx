...
const data = {
	  ...
	  results: [
	    ...
	    },
	    {
	      ...
	      id: 458897,
	      adult: false,
	      backdrop_path: "/j9oM3c4D1qiVLmweBQm78Tm2grW.jpg",
	      original_language: "en",
  ...
  items = data.results;
   function handleClick(e) {
    e.preventDefault();
     ...
     alert("Popularity is " + data);
  }
  return (
    <div>
      {items.map(function(item, i) {
        return (<div className="movie" onClick={handleClick} data={item.popularity}>
            <img className="imgMovie" src={"https://image.tmdb.org/t/p/w370_and_h556_bestv2"+item.poster_path}></img>
